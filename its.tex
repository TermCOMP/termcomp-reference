...
\begin{itemize}
    ...
    \item \text{\texttt{Omega(n\textasciicircum}$k$\texttt{)}}: A polynomial lower bound of degree $k \in \N$, i.e., $rc(\sigma) \in \Omega(|\sigma|^k)$.
      %
      \begin{itemize}
...
\begin{itemize}
    ...
    \item \text{\texttt{O(n\textasciicircum}$k$\texttt{)}}: A polynomial upper bound of degree $k \in \N$, i.e., $rc(\sigma) \in \mathcal{O}(|\sigma|^k)$.
      \begin{itemize}
      \item The output \texttt{Omega(n)} is equivalent to \texttt{Omega(n\textasciicircum 1)}.
      \item The output \texttt{Omega(1)} is equivalent to \texttt{Omega(n\textasciicircum 0)}.
      \end{itemize}
    \item \texttt{FINITE}: A finite lower bound.
\end{itemize}
